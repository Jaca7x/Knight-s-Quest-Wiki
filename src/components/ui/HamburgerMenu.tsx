        ...
        <>
            {createPortal(
                <>
                    ...
                    >
                        <span className={`h-0.5 bg-[#c9a227] transition-all duration-300 shadow-[0_0_8px_#c9a227] ${isOpen ? 'w-8 rotate-45 translate-y-[8px]' : 'w-8'}`}></span>
                        <span className={`h-0.5 bg-[#c9a227] transition-all duration-300 shadow-[0_0_8px_#c9a227] ${isOpen ? 'opacity-0' : 'w-5'}`}></span>
                        <span className={`h-0.5 bg-[#c9a227] transition-all duration-300 shadow-[0_0_8px_#c9a227] ${isOpen ? 'w-8 -rotate-45 -translate-y-[8px]' : 'w-7'}`}></span>
                    </button>
